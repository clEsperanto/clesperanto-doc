...
.. container:: text-justify
   ...
   But also provide additional support for other frameworks such as `CUDA <https://developer.nvidia.com/cuda-zone>`_ and `Metal <https://developer.apple.com/metal/>`_ to allow direct links with other libraries and maximize adaptability to different environments.
